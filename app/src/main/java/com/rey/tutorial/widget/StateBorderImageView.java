...
public class StateBorderImageView extends ImageView{
    ...
    public StateBorderImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public StateBorderImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
